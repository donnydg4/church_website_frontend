...
bootstrapApplication(AppComponent, {
    providers: [
        importProvidersFrom(BrowserModule, IonicModule.forRoot(), AppRoutingModule, MatToolbarModule, MatButtonModule, MatMenuModule, HomePageModule, SharedComponentsModule, CalendarPageModule, DevotionalsPageModule, SermonsPageModule, SeriesPageModule, GuestSpeakersPageModule, ConnectPageModule, AllEventsPageModule, OurMinistriesPageModule, MinistriesWeSupportPageModule, LeadershipPageModule, SeriesListPageModule, VideoPageModule, FaithStatementPageModule, WorshipPageModule, SozoPageModule, NgxPaginationModule, MatSnackBarModule),
